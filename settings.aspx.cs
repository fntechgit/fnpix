...
namespace fnpix
{
    public partial class settings : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (Setting s in _settings.all())
            {
                ph_tags.Controls.Add(new LiteralControl("<tr><td data-title=\"Title\">" + s.name + "</td><td data-title=\"Value\" class=\"text-right\">" + s.value + "</td><td data-title=\"Actions\"><a href=\"/settings/edit/" + s.id + "\"><i class=\"fa fa-edit\"></i></a></td></tr>"));
            }
        }
