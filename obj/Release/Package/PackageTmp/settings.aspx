<%@ Page Title="FNPIX Settings" Language="C#" MasterPageFile="~/fnpix.master" AutoEventWireup="true" CodeBehind="settings.aspx.cs" Inherits="fnpix.settings" %>
		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
					...
					<li><i class="fa fa-gears"></i> <span>System Values</span></li>
				</ol>
		...
		<!-- start: page -->
			<section class="panel">
				...
				<header class="panel-heading">
					...
					<h2 class="panel-title">System Values</h2>
				</header>
