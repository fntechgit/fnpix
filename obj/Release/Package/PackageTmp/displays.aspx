<%@ Page Title="FNPIX > Manage Event Displays" Language="C#" MasterPageFile="~/fnpix.master" AutoEventWireup="true" CodeBehind="displays.aspx.cs" Inherits="fnpix.displays" %>
    ...
    <section role="main" class="content-body">
		...
		<!-- start: page -->
			<section class="panel">
                ...
                <a href="/displays/add" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-plus-circle"></i> Add New Display</a>
					...
					<table class="table table-no-more table-bordered table-striped mb-none">
						<thead>
							<tr>
                                ...
                                <th class="text-right">Slide Duration</th>
                                <th>Actions</th>
							</tr>
						</thead>
						<tbody>
