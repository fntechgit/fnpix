...
namespace fnpix
{
    public partial class unreviewed : System.Web.UI.Page
    {
        ...
        public string unreviewed_approved = "0";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            render_media(_media.unapproved_unreviewed(Convert.ToInt32(Session["event_id"].ToString())));

            _media.review(Convert.ToInt32(Session["event_id"].ToString()));
        }
        ...
        private void get_totals()
        {
            ...
            unreviewed_approved = _approved_unreviewed.Count.ToString("0.#");
